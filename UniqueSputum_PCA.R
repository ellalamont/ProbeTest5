...
UniqueSputum_tpm_t <- as.data.frame(t(UniqueSputum_tpm))
...
summary_PCA[1,1] # PC1 explains 39% of variance
summary_PCA[2,1] # PC2 explains 18.3% of variance
summary_PCA[3,1] # PC3 explains 11.6% of variance
